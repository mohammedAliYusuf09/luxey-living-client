...
function Consultation() {
  return (
    <div className='bg-grid-white py-14 text-gray-900 flex flex-col items-center'>
        ...
        <input type="text" placeholder="Enter your email" className="bg-[#14171C] border border-action text-action px-4 py-2 text-xl lg:text-2xl xl:text-3xl font-light mt-6 rounded-md w-full md:w-[50%]"/>
